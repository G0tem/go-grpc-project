...
// Source: github.com/G0tem/go-grpc-project/db/sqlc (interfaces: Store)
//
...
func (m *MockStore) UpdateUser(arg0 context.Context, arg1 generated_db.UpdateUserParams) (generated_db.User, error) {
	m.ctrl.T.Helper()
